    ...
    public class Program : IHostedService
    {
        ...
        public Task StartAsync(CancellationToken cancellationToken)
        {
            _appLifetime.ApplicationStarted.Register(() =>
            {
                try
                {
                    var audience = _configuration["audience"] ?? "https://c8dfda4edb944ca089077125623716d7.api.westeurope.videoanalyzer.azure.net";
                    var issuer = _configuration["issuer"] ?? "https://c8dfda4edb944ca089077125623716d7.com";
